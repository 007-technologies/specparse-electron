...
// Load baked-in config (API key, build date, version). Generated by build/prepare-build.js
// at build time. In dev (npm start without a prebuild), this may be a stub with an empty
// key — we fall back to the user-entered key in electron-store.
